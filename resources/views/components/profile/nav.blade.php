...
@php
    $tabs = [
        ['key' => 'profile', 'route' => 'profile.edit', 'label' => __('profile.nav_overview')],
        ['key' => 'sessions', 'route' => 'security.sessions.index', 'label' => __('profile.nav_sessions')],
    ];
@endphp

<nav class="mb-6 overflow-x-auto rounded-xl border border-slate-200/90 bg-white p-1 shadow-sm dark:border-[#374151] dark:bg-[#1F2937]" aria-label="{{ __('profile.nav_aria') }}">
