<x-guest-layout
    :wide="true"
    :page-title="__('legal.privacy_title').' — '.config('app.name')"
    :meta-description="__('legal.privacy_meta')"
>
    <article class="legal-doc prose prose-slate max-w-none dark:prose-invert">
        <header class="mb-8 border-b border-slate-200 pb-6 dark:border-slate-700">
            <h1 class="m-0 text-2xl font-extrabold text-slate-900 dark:text-white">{{ __('legal.privacy_title') }}</h1>
